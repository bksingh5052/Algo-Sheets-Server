...
C.toPower = C.pow = function (e) {
     ...
     if (((t = Z(e.e / O)), t >= e.d.length - 1 && (r = f < 0 ? -f : f) <= xl)) return (i = mo(l, a, r, n)), e.s < 0 ? new l(1).div(i) : I(i, n, o)
     if (((s = a.s), s < 0)) {
...
var q = (function () {
     ...
     return function (n, i, o, s, a, l) {
          var f,
               ...
               z = n.d,
               $ = i.d
          if (!z || !z[0] || !$ || !$[0]) return new nr(!n.s || !i.s || (z ? $ && z[0] == $[0] : !$) ? NaN : (z && z[0] == 0) || !$ ? Xr * 0 : Xr / 0)
          for (
