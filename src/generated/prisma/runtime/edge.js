...
var Qe = (e, t, r) => ((r = e != null ? ya(ba(e)) : {}), oi(t || !e || !e.__esModule ? ar(r, 'default', { value: e, enumerable: !0 }) : r, e)),
...
C.toPower = C.pow = function (e) {
     ...
     if (((t = X(e.e / O)), t >= e.d.length - 1 && (r = f < 0 ? -f : f) <= Ol)) return (i = ho(l, a, r, n)), e.s < 0 ? new l(1).div(i) : I(i, n, o)
     if (((s = a.s), s < 0)) {
...
var q = (function () {
     ...
     return function (n, i, o, s, a, l) {
          var f,
               ...
               Y = n.d,
               $ = i.d
          if (!Y || !Y[0] || !$ || !$[0]) return new sr(!n.s || !i.s || (Y ? $ && Y[0] == $[0] : !$) ? NaN : (Y && Y[0] == 0) || !$ ? sn * 0 : sn / 0)
          for (
...
function qo(e, t, r) {
     return r ? Ze(r, ({ needs: n, compute: i }, o) => ({ name: o, needs: n ? Object.keys(n).filter((s) => n[s]) : [], compute: rc(t, o, i) })) : {}
}
function rc(e, t, r) {
     let n = e?.[t]?.compute
