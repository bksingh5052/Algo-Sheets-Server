...
var k = (e, r, t) => ((t = e != null ? bu(xu(e)) : {}), _o(r || !e || !e.__esModule ? qt(t, 'default', { value: e, enumerable: !0 }) : t, e)),
...
var ti,
     ...
     jo = !0
typeof process < 'u' &&
     (({ FORCE_COLOR: ti, NODE_DISABLE_COLORS: Mo, NO_COLOR: $o, TERM: qo } = process.env || {}), (jo = process.stdout && process.stdout.isTTY))
...
function mm(e) {
     ...
     return (
          ...
          { file: t ? null : r[2], methodName: r[1] || xt, arguments: t ? [r[2]] : [], lineNumber: r[3] ? +r[3] : null, column: r[4] ? +r[4] : null }
     )
}
...
function bm(e) {
     ...
     return (
          ...
          { file: r[3], methodName: r[1] || xt, arguments: r[2] ? r[2].split(',') : [], lineNumber: r[4] ? +r[4] : null, column: r[5] ? +r[5] : null }
     )
}
var Em = /^\s*(?:([^@]*)(?:\((.*?)\))?@)?(\S.*?):(\d+)(?::(\d+))?\s*$/i
function wm(e) {
