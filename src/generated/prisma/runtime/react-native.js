...
var Se = (e, t, r) => ((r = e != null ? ba(Pa(e)) : {}), ni(t || !e || !e.__esModule ? tr(r, 'default', { value: e, enumerable: !0 }) : r, e)),
...
S.toPower = S.pow = function (e) {
     ...
     if (((t = te(e.e / F)), t >= e.d.length - 1 && (r = u < 0 ? -u : u) <= Hl)) return (i = co(l, a, r, n)), e.s < 0 ? new l(1).div(i) : O(i, n, o)
     if (((s = a.s), s < 0)) {
...
S.toSignificantDigits = S.toSD = function (e, t) {
     var r = this,
          n = r.constructor
     return e === void 0 ? ((e = n.precision), (t = n.rounding)) : (se(e, 1, $e), t === void 0 ? (t = n.rounding) : se(t, 0, 8)), O(new n(r), e, t)
}
S.toString = function () {
     var e = this,
          t = e.constructor,
...
var j = (function () {
     ...
     return function (n, i, o, s, a, l) {
          var u,
               ...
               X = n.d,
               $ = i.d
          if (!X || !X[0] || !$ || !$[0]) return new er(!n.s || !i.s || (X ? $ && X[0] == $[0] : !$) ? NaN : (X && X[0] == 0) || !$ ? Yr * 0 : Yr / 0)
          for (
...
function $o(e, t, r) {
     return r ? it(r, ({ needs: n, compute: i }, o) => ({ name: o, needs: n ? Object.keys(n).filter((s) => n[s]) : [], compute: Ac(t, o, i) })) : {}
}
function Ac(e, t, r) {
     let n = e?.[t]?.compute
...
function Vc(e) {
     ...
     return (
          ...
          { file: r ? null : t[2], methodName: t[1] || zt, arguments: r ? [t[2]] : [], lineNumber: t[3] ? +t[3] : null, column: t[4] ? +t[4] : null }
     )
}
...
var Jc = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|rsc|resource|\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i,
...
function Kc(e) {
     ...
     return (
          ...
          { file: t[3], methodName: t[1] || zt, arguments: t[2] ? t[2].split(',') : [], lineNumber: t[4] ? +t[4] : null, column: t[5] ? +t[5] : null }
     )
}
var Hc = /^\s*(?:([^@]*)(?:\((.*?)\))?@)?(\S.*?):(\d+)(?::(\d+))?\s*$/i
function zc(e) {
