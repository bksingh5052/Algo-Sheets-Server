...
var nt = (t, e, r) => ((r = t != null ? Yo(es(t)) : {}), cn(e || !t || !t.__esModule ? Ot(r, 'default', { value: t, enumerable: !0 }) : r, t)),
...
var y,
     ...
     u = ne(() => {
          ...
          ;(os = {
               ...
               (ss = new TextEncoder()),
               (as = new TextDecoder()),
               (ls = ['utf8', 'utf-8', 'hex', 'base64', 'ascii', 'binary', 'base64url', 'ucs2', 'ucs-2', 'utf16le', 'utf-16le', 'latin1', 'latin-1']),
               (us = 4294967295)
          ns(y.prototype)
          ;(b = new Proxy(cs, {
               construct(t, [e, r]) {
...
function jo(t, e) {
     ...
     if (t.datasourceUrl && t.datasources) throw new _('Can not use "datasourceUrl" and "datasources" options at the same time. Pick one of them')
}
function tt(t, e) {
